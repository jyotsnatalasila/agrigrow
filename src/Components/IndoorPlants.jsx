...
const PLANTS = [
  {
    ...
    images: [process.env.PUBLIC_URL + "/Images/pearls.webp", process.env.PUBLIC_URL + "/Images/pearlsimg2.webp"],
    itemPrice: 90,
  },
  {
    id: 1001,
    brand: "Farmer",
    name: "Fittonia",
    images: [process.env.PUBLIC_URL + "/Images/fittonia.webp", process.env.PUBLIC_URL + "/Images/fittoniaimg2.jpg"],
    itemPrice: 160,
  },
  {
    id: 1002,
  ...
  },
  {
    id: 1004,
    brand: "Farmer",
    name: "Rosette Succulent",
    images: [process.env.PUBLIC_URL + "/Images/adrenium.webp", process.env.PUBLIC_URL + "/Images/rosette.jpg"],
    itemPrice: 150,
  },
  {
    id: 1005,
    ...
    images: [process.env.PUBLIC_URL + "/Images/hearts.png", process.env.PUBLIC_URL + "/Images/hearts.jpeg"],
    itemPrice: 80,
  },
  {
    id: 1006,
    ...
    images: [process.env.PUBLIC_URL + "/Images/bunnyears.jpg", process.env.PUBLIC_URL + "/Images/bunnyearsimg2.jpg"],
    itemPrice: 100,
  },
  {
    id: 1007,
    brand: "Farmer",
    name: "Ferns",
    images: [process.env.PUBLIC_URL + "/Images/ferns.jpg", process.env.PUBLIC_URL + "/Images/ferns.webp"],
    itemPrice: 120,
  },
  {
    id: 1008,
    brand: "Farmer",
    name: "Ficus Bonsai",
    images: [process.env.PUBLIC_URL + "/Images/ficusbonsai.jpg", process.env.PUBLIC_URL + "/Images/ficusimg2.jpg"],
    itemPrice: 400,
  },
];
...
function IndoorPlantsContent() {
  ...
  // Use wishlist context functions
  ...
  // Centralized wishlist toggle (matching Bestsellers page)
  const toggleWishlist = (plant) => {
    if (isInWishlist(plant.id)) {
      removeFromWishlistGlobal(plant.id);
    } else {
      addToWishlistGlobal(plant);
    }
  };
  ...
  const handleAddToCart = () => {
    ...
    alert(
      `${quantity} item x ${selected.name} added/updated in cart.`
    );
    setSelected(null);
    setQuantity(1);
    setCurrentRating(0);
  ...
  const sortedPlants = useMemo(() => {
    if (sortOption === "default") return [...PLANTS];
    let sorted = [...PLANTS];
        ...
        >
          {sortedPlants.map((plant) => (
            <div
              ...
              role="button"
              tabIndex={0}
              onKeyDown={(e) => e.key === "Enter" && openModal(plant)}
            ...
            >
              ...
              <button
                ...
                style={{
                  ...
                  border: "none",
                  fontSize: "24px",
                  color: isInWishlist(plant.id) ? "#8dc63f" : "#999",
                  cursor: "pointer",
                  display: "flex",
                  alignItems: "center",
            ...
            >
              ...
              <button
                ...
                style={{
                  ...
                  border: "none",
                  background: "none",
                  color: isInWishlist(selected.id) ? "#8dc63f" : "#999",
                  cursor: "pointer",
                  userSelect: "none",
                  transition: "color 0.3s ease",
                }}
              >
                {isInWishlist(selected.id) ? "❤️" : "🤍"}
              </button>
            </div>
          </div>
        )}
